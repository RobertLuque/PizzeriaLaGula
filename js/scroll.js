...
var metScroll = {
    ...
    moverse: function(e){
        ...
        propScroll.destino = this.getAttribute('href');//*Agarra los href ty
        ...
        //*scrollTo: es un metodo que te permite que te lleve a un cierto punto de la pagina
    ...
    subir: function(e){
        ...
        propScroll.intervalo = setInterval(function(){
            ...
            }else{//*return: es para dejar de realizar la funcion cuando esta en 0
                return;
            }
